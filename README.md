...
To get started, the user may go to example_cases/Lorenz96 and sequentially (in numerical order) run scripts 00_,01_,02_ to generate the data, train the neural ODE and run predictions, and finally evaluate performance.
